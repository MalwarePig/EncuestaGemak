...
Controller.GuardarEncuesta = (req, res) => {
    ...
    req.getConnection((err, conn) => {
        ...
        console.log(Nombre,Nomina,Planta,PreguntaUno,PreguntaDos,PreguntaDosText,PreguntaTres,PreguntaTresText,Tos,Fiebre,Respirar,Gusto,Garganta,Cuerpo,Cabeza,Aceptable,Area);
