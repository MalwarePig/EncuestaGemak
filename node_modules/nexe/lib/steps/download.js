...
function fetchPrebuiltBinary(compiler, step) {
    return __awaiter(this, void 0, void 0, function () {
        var downloadOptions, target, githubRelease, assetName, asset, filename;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    downloadOptions = compiler.options.downloadOptions;
                ...
                case 1:
                    ...
                    if (!asset) {
                        throw new compiler_1.NexeError(assetName + " not available, create it using the --build flag");
                    }
                    filename = compiler.getNodeExecutableLocation(target);
                    return [4 /*yield*/, download(asset.browser_download_url, path_1.dirname(filename), compiler.options.downloadOptions).on('response', function (res) {
                            var total = +res.headers['content-length'];
                            var current = 0;
                            res.on('data', function (data) {
                                current += data.length;
...
function downloadNode(compiler, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    src = compiler.src, log = compiler.log, target = compiler.target, version = target.version, _a = compiler.options, sourceUrl = _a.sourceUrl, downloadOptions = _a.downloadOptions, build = _a.build, url = sourceUrl || "https://nodejs.org/dist/v" + version + "/node-v" + version + ".tar.gz";
                    step = log.step("Downloading " + (build ? '' : 'pre-built ') + "Node.js" + (build ? "source from: " + url : ''));
