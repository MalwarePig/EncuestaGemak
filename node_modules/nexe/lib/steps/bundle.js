...
function bundle(compiler, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, bundle, cwd, input, code, _b, _c, _d, files, warnings;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _e.label = 4;
                case 4:
                    if (!(input === util_1.STDIN_FLAG)) return [3 /*break*/, 8];
                ...
                case 7:
                    _e.sent();
                    return [2 /*return*/, next()];
                case 8: return [4 /*yield*/, resolve_dependencies_1.default.apply(void 0, [input].concat(Object.keys(compiler.bundle.index).filter(function (x) { return x.endsWith('.js'); }), [{ cwd: cwd, expand: true, loadContent: false }]))];
                case 9:
                    _d = _e.sent(), files = _d.files, warnings = _d.warnings;
